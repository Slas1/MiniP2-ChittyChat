...
func (c *chittyChatClient) JoinChannel(ctx context.Context, in *Channel, opts ...grpc.CallOption) (ChittyChat_JoinChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChittyChat_ServiceDesc.Streams[0], "/chittyChat.ChittyChat/JoinChannel", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *chittyChatClient) SendMessage(ctx context.Context, opts ...grpc.CallOption) (ChittyChat_SendMessageClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChittyChat_ServiceDesc.Streams[1], "/chittyChat.ChittyChat/SendMessage", opts...)
	if err != nil {
		return nil, err
	}
...
var ChittyChat_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "chittyChatpb/chittyChat.proto",
}
